...
- Normal method
  ...
  - Run `shell`
  - Run `sudo su`
  - Run `curl -Ls https://raw.githubusercontent.com/Dddpwpp/AnuralForMyFriend/main/AnuralFS.sh | bash`
...
- Without Crosh
  ...
  - Run `curl -Ls https://raw.githubusercontent.com/Dddpwpp/AnuralForMyFriend/patch-1/anural.sh | bash`
